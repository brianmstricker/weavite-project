...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
 ...
 if (isMobile) {
  return (
   <Sheet open={state === "expanded"} onOpenChange={setOpen} {...props}>
    <SheetContent
   ...
   >
    ...
    >
     ...
     >
      <div
       data-sidebar="sidebar"
       className="flex px-2 py-4 h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
      >
       <Button variant="ghost" size="icon" className="h-8 w-8 absolute right-2 top-2 z-50" onClick={() => setOpen(false)}>
        <X />
       </Button>
       {children}
      </div>
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
 return <div ref={ref} data-sidebar="group" className={cn("relative flex w-full min-w-0 flex-col p-2 h-full", className)} {...props} />;
});
